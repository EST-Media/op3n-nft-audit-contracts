...
module.exports = {
  ...
  networks: {
    ...
    matic: { // https://speedy-nodes-nyc.moralis.io/fbaf69719371c88b92ec4257/polygon/mainnet
      url: "https://polygon-rpc.com/", // https://docs.polygon.technology/docs/develop/network-details/network
    ...
    avax: {
      ...
      accounts: process.env.PRIVATE_KEY !== undefined ? [process.env.PRIVATE_KEY] : [],
      // chainID: 43114 // https://testnet.snowtrace.io/
    },
    fuji: {
      url: "https://api.avax-test.network/ext/bc/C/rpc",
      accounts: process.env.PRIVATE_KEY !== undefined ? [process.env.PRIVATE_KEY] : [],
      // chainID: 43113 // https://testnet.snowtrace.io/
    },
    one: {
